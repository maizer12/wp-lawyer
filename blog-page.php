...
<head>
	...
	<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css?_v=20230608174734"
		rel="stylesheet">
	<link rel="stylesheet" href="css/style.min.css?_v=20230608174734">
	<link rel="preconnect" href="https://fonts.googleapis.com">
	<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
	<link
		href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&family=Open+Sans:wght@400;600&display=swap&_v=20230608174734"
		rel="stylesheet">
	<title>Главная</title>
</head>
...
<body>
	<div class="wrapper">
		<header class="header">
			<div class="header__container"><a href="/" class="header__logo logo"><img
						src="<?php bloginfo('template_url'); ?>/assets/images/logo.svg" alt="logo"></a>
				...
				<div class="header__left"><button class="header-tell"><svg width="25" height="24" viewBox="0 0 25 24"
							...
							<g clip-path="url(#clip0_259_5410)">
								<path
									d="M2.6272 0.800009C3.20237 0.213341 3.86903 -0.0533257 4.6272 7.62939e-06C5.38537 0.0533409 5.99975 0.400007 6.47034 1.04001L9.13701 4.48001C9.39845 4.80001 9.56838 5.16001 9.64681 5.56001C9.72524 5.96001 9.71217 6.34667 9.6076 6.72001L8.82328 10C8.71871 10.3733 8.79714 10.6933 9.05858 10.96L12.6664 14.64C12.9279 14.9067 13.2416 14.9867 13.6076 14.88L16.8233 14.08C17.1893 13.9733 17.5684 13.96 17.9605 14.04C18.3527 14.12 18.7056 14.2933 19.0194 14.56L22.3919 17.28C23.0194 17.76 23.3592 18.3867 23.4115 19.16C23.4638 19.9333 23.2024 20.6133 22.6272 21.2L21.137 22.72C20.5618 23.3067 19.8952 23.6933 19.137 23.88C18.3788 24.0667 17.6337 24.0267 16.9017 23.76C12.9801 22.3733 9.54224 20.1733 6.58799 17.16C3.63374 14.1467 1.47688 10.64 0.117399 6.64001C-0.144039 5.89334 -0.183254 5.13334 -0.000247799 4.36001C0.182759 3.58667 0.561844 2.90668 1.13701 2.32001L2.6272 0.800009ZM18.4703 0.960009C18.6272 0.800009 18.8102 0.720007 19.0194 0.720007C19.2285 0.720007 19.3854 0.800009 19.4899 0.960009L23.1762 4.72001C23.3331 4.88001 23.4115 5.06667 23.4115 5.28001C23.4115 5.49334 23.3331 5.65334 23.1762 5.76001L19.4899 9.52001C19.3854 9.68001 19.2285 9.76001 19.0194 9.76001C18.8102 9.76001 18.6272 9.68001 18.4703 9.52001C18.3135 9.36001 18.235 9.18667 18.235 9.00001C18.235 8.81334 18.3135 8.64001 18.4703 8.48001L20.9017 6.00001H13.8429C13.6337 6.00001 13.4638 5.93334 13.3331 5.80001C13.2024 5.66667 13.137 5.49334 13.137 5.28001C13.137 5.06667 13.2024 4.88001 13.3331 4.72001C13.4638 4.56001 13.6337 4.48001 13.8429 4.48001H20.9017L18.4703 2.00001C18.3135 1.89334 18.235 1.73334 18.235 1.52001C18.235 1.30667 18.3135 1.12001 18.4703 0.960009Z"
									fill="white" />
							</g>
							<defs>
								<clipPath id="clip0_259_5410">
									<rect width="25" height="24" fill="white" transform="matrix(1 0 0 -1 0 24)" />
								</clipPath>
							</defs>
						</svg></button>
					<ul class="socials">
						<li class="socials__item"><a href="#" class="socials__link"><svg width="36" height="36" viewBox="0 0 36 36"
									fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<ul class="language">
						<li class="language__item language-item-active">UA <span>|</span></li>
						<li class="language__item">RU <span>|</span></li>
					</ul>
					<ul class="header-contacts">
						<li class="header-contacts__item"><a href="tel:380507207182" class="header-contacts__link num-styles">+38
								(050) 720-71-82</a></li>
						<li class="header-contacts__item"><a href="tel:380988824264" class="header-contacts__link num-styles">+38
								(098) 882-42-64</a></li>
					</ul><button class="header__burger icon-menu"><span></span></button>
				</div>
			</div>
		</header>
			...
			<section class="banner banner-blog">
				<div class="breadcrumbs">
					<ul class="breadcrumbs__container breadcrumbs__items">
						<li class="breadcrumbs__item"><a href="#" class="breadcrumbs__link">Головна <span>/</span></a></li>
						<li class="breadcrumbs__item"><a href="#" class="breadcrumbs__link">Блог <span>/</span></a></li>
					</ul>
				</div>
				<div class="banner__container">
					<div class="banner__content">
						<h1 class="banner-blog-title title">Блог</h1>
		...
		<footer class="footer">
			<div class="footer__top">
				<ul class="footer__container footer__columns">
					<li class="footer-column">
						<div class="footer-column__content"><a href="#" class="footer-logo"><img
									src="<?php bloginfo('template_url'); ?>/assets/images/logo.svg" alt="logo"
						...
						</div><a href="#" class="button footer-column__button">Як знайти</a>
					</li>
					<li class="footer-socials">
						<h4 class="footer-list__name">Соц-мережі</h4>
						<ul class="footer-socials__items">
							<li class="footer-socials__item"><a href="#" class="footer-socials__link"><svg width="16" height="16"
										...
										<defs>
											<clipPath id="clip0_160_413">
												<rect width="15" height="15" fill="white" transform="matrix(1 0 0 -1 0.5 15.8799)" />
											</clipPath>
										</defs>
									</svg></a></li>
							<li class="footer-socials__item"><a href="#" class="footer-socials__link"><svg width="16" height="16"
							...
							<li class="footer-socials__item"><a href="#" class="footer-socials__link"><svg width="16" height="16"
										...
										<g clip-path="url(#clip0_160_417)">
											<path
												d="M5.2 14.9297C7 14.9297 8.6 14.4797 10 13.5797C11.2667 12.7464 12.25 11.6464 12.95 10.2797C13.6167 8.94635 13.95 7.57969 13.95 6.17969V5.77969C14.55 5.34635 15.0667 4.81302 15.5 4.17969C14.9333 4.44635 14.35 4.61302 13.75 4.67969C14.4167 4.27969 14.8667 3.71302 15.1 2.97969C14.4667 3.34635 13.8167 3.59635 13.15 3.72969C12.65 3.22969 12.0583 2.92135 11.375 2.80469C10.6917 2.68802 10.0417 2.79635 9.425 3.12969C8.80833 3.46302 8.35833 3.94635 8.075 4.57969C7.79167 5.21302 7.73333 5.86302 7.9 6.52969C6.66667 6.46302 5.49167 6.15469 4.375 5.60469C3.25833 5.05469 2.31667 4.29635 1.55 3.32969C1.15 4.02969 1.04167 4.77135 1.225 5.55469C1.40833 6.33802 1.83333 6.96302 2.5 7.42969C2 7.39635 1.53333 7.26302 1.1 7.02969V7.07969C1.1 7.81302 1.33333 8.46302 1.8 9.02969C2.26667 9.59635 2.85 9.94635 3.55 10.0797C3.28333 10.1797 3.01667 10.2297 2.75 10.2297C2.55 10.2297 2.36667 10.213 2.2 10.1797C2.4 10.7797 2.75833 11.2797 3.275 11.6797C3.79167 12.0797 4.38333 12.2797 5.05 12.2797C4.51667 12.713 3.91667 13.0464 3.25 13.2797C2.58333 13.513 1.91667 13.6297 1.25 13.6297C0.983333 13.6297 0.733333 13.613 0.5 13.5797C1.93333 14.4797 3.5 14.9297 5.2 14.9297Z"
												fill="#C2873F" />
										</g>
										<defs>
					...
					<li class="footer-list footer-list_df">
						<div class="footer-list__content">
							<h4 class="footer-list__name">Наші контакти</h4>
							<ul class="footer-list__items">
								<li class="footer-list__item"><a href="mailto:info@example.com"
										class="footer-list__link">info@example.com</a></li>
								<li class="footer-list__item"><a href="tel:380507207182" class="footer-list__link">+38 (050)
										720-71-82</a></li>
								<li class="footer-list__item"><a href="tel:380988824264" class="footer-list__link">+38 (050)
										720-71-82</a></li>
							</ul>
						</div>
						<ul class="socials">
					...
					<li class="footer-list footer-list_oh">
						<h4 class="footer-list__name">Для клієнта</h4>
						<ul class="footer-list__items">
							<li class="footer-list__item"><a href="#" class="footer-list__link">Про мене</a></li>
							<li class="footer-list__item"><a href="#" class="footer-list__link">Послуги</a></li>
							<li class="footer-list__item"><a href="#" class="footer-list__link">Кейси</a></li>
							<li class="footer-list__item"><a href="#" class="footer-list__link">Блог</a></li>
						</ul>
					</li>
					<li class="footer-list footer-list_none">
						<h4 class="footer-list__name">Популярні послуги</h4>
						<ul class="footer-list__items">
							<li class="footer-list__item"><a href="#" class="footer-list__link">Ліцензія на алкоголь/тютюн</a></li>
							<li class="footer-list__item"><a href="#" class="footer-list__link">Ліквідація ТОВ/ФОП</a></li>
							<li class="footer-list__item"><a href="#" class="footer-list__link">Ліцензія на алкоголь/тютюн</a></li>
							<li class="footer-list__item"><a href="#" class="footer-list__link">Ліквідація ТОВ/ФОП</a></li>
							<li class="footer-list__item"><a href="#" class="footer-list__link">Ліцензія на алкоголь/тютюн</a></li>
						</ul>
			...
			<div class="footer__bottom">
				<div class="footer__container">
					...
					<p class="footer__text">Створено в <a href="#" class="footer__link">MAXOPEN</a></p>
				</div>
			</div>
		</footer>
	</div>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js?_v=20230608174734"></script>
	<script src="https://code.jquery.com/ui/1.13.1/jquery-ui.min.js?_v=20230608174734"></script>
	<script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js?_v=20230608174734"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.3/js/intlTelInput.min.js?_v=20230608174734"></script>
	<script src="js/app.min.js?_v=20230608174734"></script>
</body>
