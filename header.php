				...
				<div class="header__left"><button class="header-tell"><svg width="25" height="24" viewBox="0 0 25 24"
					...
					<ul class="socials">
						<li class="socials__item">
							<a href="<?php the_field('option_whatsapp', 'option'); ?>" class="socials__link" target="_blank">
						...
						<li class="socials__item">
							<a href="<?php the_field('option_viber', 'option'); ?>" class="socials__link" target="_blank">
								<svg width="36" height="36" viewBox="0 0 36 36"
									fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<li class="socials__item">
							<a href="<?php the_field('option_telegram', 'option'); ?>"  class="socials__link" target="_blank"><svg width="36" height="36" viewBox="0 0 36 36"
									fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<ul class="header-contacts">
						<?php $tell_group = get_field('option_phone', 'options'); ?>
						<li class="header-contacts__item">
							<a href="tel:<?php echo $tell_group['option_phone1_num1']; ?>" class="header-contacts__link num-styles">
								<?php echo $tell_group['option_phone_num1']; ?>
							</a>
						</li>
						<li class="header-contacts__item">
							<a href="tel:<?php echo $tell_group['option_phone2_num2']; ?>" class="header-contacts__link num-styles">
								<?php echo $tell_group['option_phone_num2']; ?>
							</a>
						</li>
